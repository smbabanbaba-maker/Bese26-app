...
export const PLANS = {
  basic: { name: 'Basic', amountNaira: 2500, amountKobo: 250000, env: 'PAYSTACK_BASIC_PLAN_CODE', listingLimit: 15 },
  premium: { name: 'Premium', amountNaira: 4500, amountKobo: 450000, env: 'PAYSTACK_PREMIUM_PLAN_CODE', listingLimit: 35 },
  business: { name: 'Business', amountNaira: 7000, amountKobo: 700000, env: 'PAYSTACK_BUSINESS_PLAN_CODE', listingLimit: 60 },
};
