import { assertPaymentOwner, fulfillSuccessfulPayment, getSupabaseAdmin, paystackRequest, readJson, requireUser, sendJson } from '../../lib/server/paystack.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    try { assertPaymentOwner(data, user.id); }
    catch (ownerError) { return sendJson(res, 403, { error: ownerError.message }); }
