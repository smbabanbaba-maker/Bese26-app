...
function AppContent() {
  ...
  const goPublicSection = (section) => { navigate('home'); window.setTimeout(() => document.getElementById(section)?.scrollIntoView({ behavior: 'smooth', block: 'start' }), 80); window.history.replaceState({}, '', `/#${section}`); };
