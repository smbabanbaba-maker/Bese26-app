...
function PublicStorefrontLayout({ title, share, children }) {
  ...
  return <div className="public-business-shell"><header className="public-business-topbar"><a href="https://www.bese26.shop/" className="public-brand"><span className="brand-mark">B</span><strong>Bese26<span>.shop</span></strong></a><button type="button" className="secondary-button" onClick={share}>Share</button></header><main className="public-business-main"><div className="storefront-shell-intro">Your public Bese26 shop</div>{children}</main><footer className="public-business-footer">Powered by Bese26.shop</footer></div>;
}
...
function PublicBusinessPage({ handle }) {
  ...
  return <PublicStorefrontLayout title={business.business_name} share={share}><PublicProfileHeader business={business} profile={ownerProfile} listings={listings} share={share} /><PublicListingSection title={`Listings from ${business.business_name}`} listings={listings} /></PublicStorefrontLayout>;
}
