...
function PublicBusinessPage({ handle }) {
  ...
  const share = async () => { const url = `https://bese26.shop/${business.business_handle}`; if (navigator.share) await navigator.share({ title: business.business_name, text: business.description || business.business_name, url }); else { await navigator.clipboard?.writeText(url); setNotice('Store link copied.'); } };
