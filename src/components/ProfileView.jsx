...
export default function ProfileView({ onDemoAction, isDark, onToggleTheme, onNavigate, isActive = true }) {
  ...
  if (subPage !== 'main') return <SimpleInfoPage page={{ ...subpages[subPage], key: subPage }} onBack={() => setSubPage('main')} onDemoAction={onDemoAction} isDark={isDark} onToggleTheme={onToggleTheme} />;
