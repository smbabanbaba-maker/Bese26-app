...
export default function ProfileView({ user, onAuthRequired, onSignOut, onDemoAction, isDark, onToggleTheme, onNavigate, onCreateListing, onEditListing, onOpenListing, onToggleSave, isAdmin = false, onOpenAdmin, onOpenSubscription, isActive = true }) {
  ...
  const paymentItems = [{ label: 'Wallet', description: 'Wallet balance and transfers coming soon', icon: WalletCards, page: 'wallet', tone: 'coral' }, { label: 'Subscription', description: 'View seller plans and free posts', icon: Tag, page: 'subscription', tone: 'lavender' }, { label: 'Boosting', description: 'Promotion tools coming soon', icon: ArrowRight, page: 'boosting', tone: 'gold' }, { label: 'Payment History', description: 'View your verified payment records', icon: FileText, page: 'payment-history', tone: 'navy' }];
