    ...
    try {
      ...
      setHistory((current) => [{
        ...
        listing: {
          ...
          location_city: listing?.raw?.location_city,
          location_state: listing?.raw?.location_state,
